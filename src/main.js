...
//import korokForest from "../resources/song/korokForest.mp3";
...
class Game {
  ...
  _Initialize() {
    ...
    audioLoader.load("../resources/song/korokForest.mp3", (buffer) => {
    ...
    this._scene.add(audio);

    const swordSound = new THREE.Audio(listener);
    audioLoader.load("../resources/song/sword.mp3", (buffer) => {
      swordSound.setBuffer(buffer);
      swordSound.setVolume(1.0);
      swordSound.setLoop(false); // Desabilita o looping
    });

    // Evento para reproduzir o som da espada quando a tecla "espaço" for pressionada
    window.addEventListener("keydown", (event) => {
      if (event.code === "Space") {
        setTimeout(() => {
          swordSound.play();
        }, 500); // Delay de 1 segundo (ajuste conforme necessário)
      }
    });
  ...
  _LoadPlayer() {
    ...
    for (let i = 0; i < 50; ++i) {
      const monsters = [
        ...
        {
          resourceName: "Alien_Tall.fbx",
          resourceTexture: "Alien_Tall_Texture.png",
        },
        // bugado =>
        // {
        //   resourceName: "Bat.fbx",
        //   resourceTexture: "Bat_Texture.png",
        // },
        //bugado =>
        // {
        //   resourceName: "Bee.fbx",
        //   resourceTexture: "Bee_Texture.png",
        // },
        {
        ...
        // bugado =>
        // {
        //   resourceName: "Chicken.fbx",
        //   resourceTexture: "Chicken_Texture.png",
        // },
        {
          resourceName: "Crab.fbx",
          resourceTexture: "Crab_Texture.png",
        },
        // bugado =>
        // {
        //   resourceName: "Cthulhu.fbx",
        //   resourceTexture: "Cthulhu_Texture.png",
        // },
        {
        ...
        {
          resourceName: "Deer.fbx",
          resourceTexture: "Deer_Texture.png",
        },
        {
          resourceName: "Demon.fbx",
          resourceTexture: "Demon_Texture.png",
        },
        {
        ...
        //Bugado =>
        // {
        //   resourceName: "Mushroom.fbx",
        //   resourceTexture: "Mushroom_Texture.png",
        // },
        {
          resourceName: "Panda.fbx",
          resourceTexture: "Panda_Texture.png",
        },
        //Bugado =>
        // {
        //   resourceName: "Pig.fbx",
        //   resourceTexture: "Pig_Texture.png",
        // },
        //Bugado =>
        // {
        //   resourceName: "Penguin.fbx",
        //   resourceTexture: "Penguin_Texture.png",
        // },
        {
        ...
        {
          resourceName: "Tree.fbx",
          resourceTexture: "Tree_Texture.png",
        },
        //bugado =>
        {
          resourceName: "YellowDragon.fbx",
          resourceTexture: "YellowDragon_Texture.png",
        },
        {
          resourceName: "Yeti.fbx",
          resourceTexture: "Yeti_Texture.png",
        },
      ];
